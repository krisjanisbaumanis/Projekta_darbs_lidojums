...
# ŠIS KONKRĒTAIS KODS IR NEDAUDZ PĀRVEIDOTS TĀ, LAI TAS STRĀDĀ GITHUB (NESTRĀDĀ 100% VIENMĒR), 
# kā arī outputs varētu izskatīties savādāk nekā manā video, lūgums apskatīt manis izveidoto video, kas ir pievienots readme failā
# APAKŠĀ IR ORIĢINĀLAIS KODS, KAS IR MANĀ IERĪCĒ VISUAL STUDIO CODE, UN KAS STRĀDA VIENMĒR :)
import selenium
...
password = #jāieraksta sava parole, vai piekļuves kods mans piekļuves kods ir izdzēsts
file = 'Cenas.xlsx'
...
# wb = load_workbook("Darbi atseviski /lidojums/Cenas.xlsx")
# ws = wb["Sheet1"]
# ws.append(turp)
# ws.append(atpakal)
# empt_row = [' ']*ws.max_column 
# ws.append(empt_row) # ieliekam vienu tukšu rindu
# wb.save("Darbi atseviski /lidojums/Cenas.xlsx")
# wb.close()
...
# filename = 'Darbi atseviski /lidojums/Cenas.xlsx'
